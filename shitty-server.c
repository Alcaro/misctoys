...
#endif
/*
 * Shitty Server: an unusually aggressive Discard Protocol server <https://en.wikipedia.org/wiki/Discard_Protocol>
...
BPF_JUMP(BPF_JMP|BPF_JEQ, (uint32_t)(AUDIT_ARCH_X86_64), 0,17),
BPF_STMT(BPF_LD|BPF_W|BPF_ABS, (uint32_t)(((offsetof(struct seccomp_data, nr))))),
BPF_JUMP(BPF_JMP|BPF_JEQ, (uint32_t)(23), 14,0),
BPF_JUMP(BPF_JMP|BPF_JEQ, (uint32_t)(270), 13,0),
